...
function RegisterForm() {
  ...
  const [popup, setPopUpPoperties] = useState({
    message: null,
    onClose: null,
    type: null,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.data?.code == 100200) {
        ...
        // This effect runs when `isPopupVisible` changes
        setPopUpPoperties({
              ...
              <div className="space-y-4">
                ...
                <div className="flex pb-3">
                  ...
                  <div className="relative w-full">
                    ...
                    />
                    <span className="absolute inset-y-0 right-2 flex items-center text-gray-600 hover:text-gray-900">
                      {showPassword ? (
